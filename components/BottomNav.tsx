...
import { LayoutGrid, MessageCircle, Calendar, Heart, Settings, LucideIcon } from 'lucide-react';
...
const NAV_ITEMS: NavItemConfig[] = [
  ...
  { id: 'care', icon: Calendar, label: 'Cuidados', pages: ['care_agenda', 'mom_agenda', 'child_agenda', 'integrated_agenda', 'routines_list', 'routine_detail', 'habit_selection', 'add_child', 'children_selection'], target: 'care_agenda' },
  { id: 'selfcare', icon: Heart, label: 'Autocuidado', pages: ['self_care_selection', 'mom_self_care'], target: 'self_care_selection' },
