                ...
                <div className="h-32 w-full flex items-center justify-center relative bg-slate-50/50 border-b border-slate-50">
                  ...
                  {partner.user_id === currentUserId && (
                    <div className="absolute top-4 right-4">
                      <button onClick={() => setActiveMenu(activeMenu === partner.id ? null : partner.id)} className="p-2 bg-white/80 rounded-full text-slate-300 hover:text-slate-500 shadow-sm"><MoreVertical size={20} /></button>
