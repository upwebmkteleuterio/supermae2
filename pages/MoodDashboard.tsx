...
import { ChevronDown, BarChart3, TrendingUp, Calendar, Sparkles, Baby } from 'lucide-react';
...
export const MoodDashboard: React.FC = () => {
  ...
  // Fix: Explicitly typing history as Record<string, string[]> to avoid 'unknown' type issues in entries iteration
  ...
  const donutData = useMemo(() => {
    ...
    // Fix: Explicitly casting values from entries to string[] to resolve type errors
  ...
  return (
    <Layout title="Dashboard de emoções" showBack themeColor="bg-[#F8F9FE]">
      <div className="px-6 pt-4 pb-32">
        ...
        {/* Seletor de Filho (Se aba filho ativa) */}
        {activeTab === 'child' && (
