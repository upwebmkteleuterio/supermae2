  ...
  return (
    <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-50 mb-8">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h3 className="font-bold text-slate-800">Resumo do humor essa semana: {targetName}</h3>
      </div>
        ...
        {data.length > 0 ? (
          <>
            <div className="relative w-48 h-48 mb-10">
              ...
              {/* O centro agora fica limpo conforme solicitado, sem preferência temática */}
            </div>
          ...
          <div className="py-12 text-center flex flex-col items-center">
            ...
            <p className="text-slate-300 text-sm font-medium italic text-center">Nenhum registro emocional nesta semana.</p>
          </div>
        )}
      </div>
    </div>
